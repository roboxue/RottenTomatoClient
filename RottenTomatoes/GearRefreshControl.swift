...
public class GearRefreshControl: UIRefreshControl {
    ...
    public func setupRefreshControl() {
        ...
        refreshContainerView.backgroundColor = backgroundColor
        ...
        centerGear.tintColor = tintColor
        ...
        bottomGear.tintColor = tintColor
